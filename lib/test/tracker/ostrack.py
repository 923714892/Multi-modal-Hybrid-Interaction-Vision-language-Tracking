...
class OSTrack(BaseTracker):
    ...
    def initialize(self, image, info: dict):
        ...
        self.text_input = self._text_input_process(info['init_nlp'], 36)
    ...
    def track(self, image, info: dict = None):
        ...
        with torch.no_grad():
            ...
            hooks = []
            for i in range(1):
                hooks.append(self.network.norm_3.register_forward_hook(
            ...
            for hook in hooks:
                ...
                vis_attn_maps(attn_weights, q_w=16, k_w=8, skip_len=0, x1=self.z_patch_arr, x2=x_patch_arr,
                              ...
                              save_path='/home/data/zgt/CVPR2024/OSTrack-main-no-prompt/visuall-t/%04d' % self.frame_id)
